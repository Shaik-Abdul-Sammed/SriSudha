# API Documentation - EduFlow ERP Backend

## Overview
RESTful API for the EduFlow Educational Resource Planning system with role-based access and persistent search functionality.

## Base URL
- Development: `http://localhost:4000/api`
-- Production: `https://api.eduflow.edu/api`
...
## Support
For API issues or questions, contact: api-support@eduflow.edu
