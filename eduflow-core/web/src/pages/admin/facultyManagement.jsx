...
const initialFaculty = [
  { id: 'FAC001', name: 'Dr. Kavitha Sharma', subject: 'Mathematics', stream: 'MPC/MBIPC', active: true, email: 'kavitha@eduflow.ac.in', phone: '9876543210' },
  { id: 'FAC002', name: 'Dr. Ravi Kumar', subject: 'Physics', stream: 'MPC/BIPC', active: true, email: 'ravi@eduflow.ac.in', phone: '9876543211' },
  { id: 'FAC003', name: 'Dr. Sujata Rao', subject: 'Chemistry', stream: 'All Streams', active: true, email: 'sujata@eduflow.ac.in', phone: '9876543212' },
  { id: 'FAC004', name: 'Dr. Padma Rao', subject: 'Biology', stream: 'BIPC/MBIPC', active: true, email: 'padma@eduflow.ac.in', phone: '9876543213' },
  { id: 'FAC005', name: 'Mrs. Anitha Reddy', subject: 'English', stream: 'All Streams', active: false, email: 'anitha@eduflow.ac.in', phone: '9876543214' },
]
          ...
          <form onSubmit={handleCreate} className="card border-0 shadow-sm" style={{ borderRadius: '1.25rem', padding: '1.5rem', display: 'grid', gap: '1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '0.875rem' }}>
              ...
              <div>
                ...
                <input required type="email" className="form-control form-control-sm" placeholder="e.g. harish@eduflow.ac.in" value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))} />
              </div>
              <div>
