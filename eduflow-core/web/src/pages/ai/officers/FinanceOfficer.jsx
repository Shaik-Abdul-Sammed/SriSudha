...
import { ArrowLeft, Send, Sparkles, DollarSign, PieChart, CreditCard, FileText } from 'lucide-react';
...
export default function FinanceOfficer() {
  ...
  const handleReconcile = async (actionName) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/api/v1/officers/finance/reconcile', {
        method: 'POST',
        headers: {
