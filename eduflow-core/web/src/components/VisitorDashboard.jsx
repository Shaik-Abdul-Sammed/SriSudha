    ...
    <div style={{ animation: 'fadeInUp 0.45s ease' }}>
        ...
        <div className="col-12 col-lg-6">
          <div className="card border-0 shadow-sm" style={{ borderRadius: '1.25rem' }}>
            <div className="card-body p-4">
              <h2 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: '1.25rem', color: config.accentColor }}>📋 Why Choose EduFlow?</h2>
      ...
      <div style={{ marginTop: '2rem', textAlign: 'center', padding: '2rem', borderRadius: '1.25rem', background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(139, 92, 246, 0.05))', border: '1px solid rgba(139, 92, 246, 0.2)' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <a href="mailto:admissions@eduflow.edu.in" className="btn" style={{ background: 'rgba(139, 92, 246, 0.1)', color: config.accentColor, border: `1px solid ${config.accentColor}30`, fontWeight: 700, borderRadius: '0.875rem', padding: '0.7rem 1.5rem', textDecoration: 'none' }}>
            📧 Admission Inquiry
          </a>
        </div>
      </div>
